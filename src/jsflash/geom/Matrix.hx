...
class Matrix
{
   ...
   public function clone() { return new jsflash.geom.Matrix(a,b,c,d,tx,ty); }
   ...
   public function invert() : jsflash.geom.Matrix
   {
      var norm = a*d-b*c;
      if (norm==0)
      {
   ...
   */
   public function concat(m:jsflash.geom.Matrix)
   {
      var a1 = a*m.a + b*m.c;
      b = a*m.b + b*m.d;
      a = a1;
   ...
   public function mult(m:jsflash.geom.Matrix)
   {
