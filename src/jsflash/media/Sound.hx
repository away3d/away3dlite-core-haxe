...
**/
class Sound extends jsflash.events.EventDispatcher {
	...
	**/
	public function load(stream : URLRequest, ?context : SoundLoaderContext) : Void
	{
		...
		m_loader.dataFormat = jsflash.net.URLLoaderDataFormat.BINARY;
