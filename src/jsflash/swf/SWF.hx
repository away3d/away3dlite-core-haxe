package jsflash.swf;
import jsflash.swf.SWFStream;
import jsflash.swf.Tags;
import jsflash.swf.Character;
...
import jsflash.display.BitmapDataRenderer;
...
class SWF
{
   ...
   public function CreateInstance() : jsflash.swf.MovieClip
   {
      var result = new jsflash.swf.MovieClip();
