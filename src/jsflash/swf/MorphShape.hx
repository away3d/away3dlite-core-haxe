...
import jsflash.display.GraphicsLike;
...
class MorphShape
{
   ...
   public function new(inSWF:SWF, inStream:SWFStream, inVersion:Int)
   {
      ...
      // Render( new jsflash.display.DebugGfx());
   }
   ...
   function ReadFillStyles(inStream:SWFStream,inVersion:Int) : MorphRenderFuncList
   {
      ...
      for(i in 0...n)
      {
         ...
         else if ( (fill & 0x10) !=0 )
         {
            ...
            //var type = fill==ftLinear ? jsflash.display.GradientType.LINEAR :
                                         //jsflash.display.GradientType.RADIAL;
