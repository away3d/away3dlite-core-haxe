...
*/
...
#elseif js
      if (inNME>=canvas.KeyCode.F1 && inNME<=canvas.KeyCode.F15)
         return inNME - canvas.KeyCode.F1 + KeyCode.F1;

      if (inNME>=canvas.KeyCode.KP0 && inNME<=canvas.KeyCode.KP9)
         return inNME - canvas.KeyCode.KP0 + KeyCode.KP0;
#end
...
#elseif js
         case canvas.KeyCode.UP : return UP;
         case canvas.KeyCode.RIGHT : return RIGHT;
         case canvas.KeyCode.CAPSLOCK : return CAPSLOCK;
   ...
   static public function ConvertLocation(inNME:Int)
   {
      ...
      if (inNME == nme.KeyCode.RCTRL || inNME==nme.KeyCode.RSHIFT)
         return 1;
#elseif js
      if (inNME == canvas.KeyCode.CONTROL || inNME==canvas.KeyCode.SHIFT)
         return 1;
#end
