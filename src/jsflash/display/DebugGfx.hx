...
import jsflash.display.SpreadMethod;
import jsflash.display.InterpolationMethod;
import jsflash.display.CapsStyle;
import jsflash.display.JointStyle;
import jsflash.display.LineScaleMode;
...
class DebugGfx
{
  ...
  static var print = DoTrace;
   ...
   public function beginGradientFill(type : jsflash.display.GradientType,
                 colors : Array<Dynamic>,
                 alphas : Array<Dynamic>,
                 ratios : Array<Dynamic>,
                 ?matrix : Matrix,
...
#elseif js
   public function RenderGlyph(inFont:canvas.FontHandle,inChar:Int,
            inX:Float,inY:Float,?inUseFreeType:Bool):Void
   {
      print("gfx.RenderGlyph( " + inChar + ")");
   }
