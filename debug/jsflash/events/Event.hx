...
class Event
{
   ...
   public var capturing(default, null):Bool;

   var mIsCancelled:Bool;
   var mIsCancelledNow:Bool;

   public function new(inType : String, inBubbles : Bool=false, inCancelable : Bool=false, inCapturing:Bool = true)
   {
      type = inType;
      bubbles = inBubbles;
